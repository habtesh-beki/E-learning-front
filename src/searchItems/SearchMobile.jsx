...
function Search({ cour }) {
  ...
  return (
    <div className="flex flex-col  m-10 items-center" >
      <div className="flex flex-col gap-4 border w-full cursor-pointer hover:border-black" onClick={handleClick}>
        <img className="w-full h-48" src={cour.img} alt={cour.title} />
        <div className="ml-4">
          <div className="text-xl mb-2">{cour.title}</div>
          <p className="w-full text-sm">{cour.desc}</p>
